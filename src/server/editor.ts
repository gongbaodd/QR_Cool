...
import { assembleResolved, markerBandRects } from '../core/assemble.js'
import { renderRegionMask } from '../core/artifacts.js'
import { decodePng, rgbaToPng } from '../core/image.js'
import { buildManualRegionMask, detectRegionMask } from '../core/mask.js'
import { placeQr, findClosestSquare } from '../core/placement.js'
import { generateQrFromContent, decodeQrRawDetailed, inspectAntfuQr, normalizeQr } from '../core/qr.js'
import { buildModuleLattice, computeSafeArea, computePlateModules, computeRimModules } from '../core/module-cut.js'
import { selectPatternVersion } from '../core/pattern.js'
...
import type { QrMetadata, RegionMask } from '../core/types.js'
import type { ResolvedLayout } from '../core/types.js'
