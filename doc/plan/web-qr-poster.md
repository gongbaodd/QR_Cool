...
1. **Content:** accept one nonblank line of text or a URL. Preserve the exact entered value, including surrounding spaces; use trimming only to detect an empty value. Report newline and QR-capacity errors beside the field. A URL is encoded as text and is never fetched.
