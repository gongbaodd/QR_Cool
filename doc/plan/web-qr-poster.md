...
- Draw immediate drag/resize/rotation feedback locally. Do not scan the mask or call the worker while a gesture is moving or when it ends. Assembly is the exact validation boundary; it rejects invalid placement without moving the QR or replacing the editable preview.
