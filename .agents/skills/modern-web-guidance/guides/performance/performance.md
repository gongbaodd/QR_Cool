...
```html
<!-- Standard LCP Image -->
<img src="/images/hero.webp" alt="Hero Product" fetchpriority="high" width="1200" height="600" />
...
- **DO use `scheduler.yield()` with a fallback**: Utilize the modern `scheduler.yield()` API to place task continuations at the _front_ of the queue, falling back to `setTimeout` wrapped in a Promise for unsupported browsers.
...
<picture>
  ...
  <img src="hero-800w.jpg" alt="Descriptive text" width="800" height="600" fetchpriority="high" loading="eager" />
</picture>
...
```html
<video controls width="1200" height="675" poster="/images/video-poster.webp" preload="none" loading="lazy">
